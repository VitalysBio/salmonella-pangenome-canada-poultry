...
# tree file
tree <- read.tree("salmonella_ST15.treefile")
...
p <- ggtree(tree_grouped, aes(color = Province), layout = "rectangular", linewidth = 0.8) %<+% tree_data +
  ...
  labs(
    title = "Phylogenetic tree of Salmonella enterica subsp. enterica serovar Heidelberg"
  )
...
ggsave("R_salmonella_enterica_Heidelberg_tree_figure.pdf", p, width = 14, height = 10)
ggsave("R_salmonella_enterica_Heidelberg_tree_figure.jpg", p, width = 14, height = 10, dpi = 300)
...
ggsave(
  "R_salmonella_enterica_Heidelberg_tree_figure.png",
  p,
  width = 14,
  height = 10,
  dpi = 300,
